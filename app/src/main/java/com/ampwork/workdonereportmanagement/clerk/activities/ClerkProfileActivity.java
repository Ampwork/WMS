...
import com.ampwork.workdonereportmanagement.hod.activities.HodProfileActivity;
...
public class ClerkProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clerk_profile);
        ...
        if (enteredEmailId.isEmpty() || !enteredEmailId.matches(emailPattern)) {
            ...
            if (enteredOldPassword.length() < 6) {
                ...
                if (enteredEmailId.equalsIgnoreCase(email) && enteredPhone.equalsIgnoreCase(phone)
                    ...
                    Toast.makeText(ClerkProfileActivity.this, "No Data changes found", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void UpdateProfileData(UserInfo userInfo, boolean isPasswordChange) {
        ...
        call.enqueue(new Callback<ApiResponse>() {
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                ...
                switch (statusCode) {
                    case 200:
                        hideProgressDialog();
                        if (!status) {
                            Toast.makeText(ClerkProfileActivity.this, "Profile not updated", Toast.LENGTH_SHORT).show();
                        } else {
                            if (msg.equals("Profile Details Updated.!!")) {
                                Toast.makeText(ClerkProfileActivity.this, "Profile details updated", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<ApiResponse> call, Throwable t) {
                hideProgressDialog();
                Toast.makeText(ClerkProfileActivity.this, "" + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    public void logOutDialog() {
        MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(ClerkProfileActivity.this);
        ...
        builder.setPositiveButton("Logout",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i = new Intent(ClerkProfileActivity.this, LoginActivity.class);
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ClerkProfileActivity.this);
        ...
        call.enqueue(new Callback<ApiResponse>() {
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                ...
                switch (statusCode) {
                    case 200:
                        ...
                        if (status) {
                            if (msg.equals("Profile Pic Updated")) {
                                ...
                                Toast.makeText(ClerkProfileActivity.this, "Profile picture updated", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(ClerkProfileActivity.this, "Please select valid file", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(ClerkProfileActivity.this, "Please select valid file", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    case 500:
                        hideProgressDialog();
                        Toast.makeText(ClerkProfileActivity.this, "Server error", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (addJpgSignatureToGallery(signatureBitmap)) {
                    ...
                    Toast.makeText(ClerkProfileActivity.this, "Unable to store the signature", Toast.LENGTH_SHORT).show();
                }
                dialog.dismiss();
            }
        });
                    ...
                    case 200:
                        ...
                        if (status) {
                            if (msg.equals("Signature Updated")) {
                                ...
                                Toast.makeText(ClerkProfileActivity.this, "Signature Updated", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(ClerkProfileActivity.this, "Error occurred try again later", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(ClerkProfileActivity.this, "Error occurred try again later", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void showProgressDialog(String msg) {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(ClerkProfileActivity.this);
