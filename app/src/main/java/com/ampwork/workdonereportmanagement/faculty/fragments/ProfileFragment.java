...
public class ProfileFragment extends Fragment {
    ...
    private void initializeViews(View root) {
        ...
        tvFullName = root.findViewById(R.id.tvName);
        tvUserRole = root.findViewById(R.id.tvRole);
        emailLayout = root.findViewById(R.id.emailInputLayout);
        edEmailId = root.findViewById(R.id.emailEd);
        phoneLayout = root.findViewById(R.id.phoneInputLayout);
        edPhone = root.findViewById(R.id.phoneEd);
        aboutLayout = root.findViewById(R.id.aboutInputLayout);
        edAbout = root.findViewById(R.id.aboutEd);
        changePswCheckBox = root.findViewById(R.id.chgPwdChkBox);
        oldPasswordLayout = root.findViewById(R.id.oldPasswordInputLayout);
        edOldPassword = root.findViewById(R.id.oldPasswordEdt);
        newPasswordLayout = root.findViewById(R.id.newPasswordInputLayout);
        edNewPassword = root.findViewById(R.id.newPasswordEdt);
        updateBtn = root.findViewById(R.id.btnUpdate);
        ivLogout = root.findViewById(R.id.ivLog);
        addSignBtn = root.findViewById(R.id.signBtn);
        ivSign = root.findViewById(R.id.signIv);
    }
        ...
        if (enteredEmailId.isEmpty() || !enteredEmailId.matches(emailPattern)) {
            ...
            if (enteredOldPassword.length() < 6) {
                ...
                if (enteredEmailId.equalsIgnoreCase(email) && enteredPhone.equalsIgnoreCase(phone)
                    ...
                    Toast.makeText(getActivity(), "No Data changes found", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    case 200:
                        ...
                        if (status) {
                            if (msg.equals("Profile Pic Updated")) {
                                ...
                                Toast.makeText(getActivity(), "Please select valid file", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(getActivity(), "Please select valid file", Toast.LENGTH_SHORT).show();
                        }
