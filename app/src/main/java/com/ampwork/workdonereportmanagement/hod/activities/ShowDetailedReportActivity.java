...
public class ShowDetailedReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_detailed_report);
    ...
    private void initializeRecyclerView() {
        ...
        if (!addReportModels.isEmpty()) {
            reportAdapter = new MonthlyReportAdapter(ShowDetailedReportActivity.this, addReportModels);
    ...
    private void AlertUserToContinue() {
        MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(ShowDetailedReportActivity.this);
        ...
        builder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(ShowDetailedReportActivity.this, SignAndSubmitReportActivity.class);
    ...
    private void showProgressDialog(String msg) {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(ShowDetailedReportActivity.this);
