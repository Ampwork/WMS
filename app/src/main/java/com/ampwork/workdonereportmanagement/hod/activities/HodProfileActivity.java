...
public class HodProfileActivity extends AppCompatActivity {
        ...
        if (enteredEmailId.isEmpty() || !enteredEmailId.matches(emailPattern)) {
            ...
            if (enteredOldPassword.length() < 6) {
                ...
                if (enteredEmailId.equalsIgnoreCase(email) && enteredPhone.equalsIgnoreCase(phone)
                    ...
                    Toast.makeText(HodProfileActivity.this, "No Data changes found", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void UpdateProfileData(UserInfo userInfo, boolean isPasswordChange) {
        ...
        call.enqueue(new Callback<ApiResponse>() {
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                ...
                switch (statusCode) {
                    case 200:
                        hideProgressDialog();
                        if (!status) {
                            Toast.makeText(HodProfileActivity.this, "Profile not updated", Toast.LENGTH_SHORT).show();
                        } else {
                            if (msg.equals("Profile Details Updated.!!")) {
                                Toast.makeText(HodProfileActivity.this, "Profile details updated", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<ApiResponse> call, Throwable t) {
                hideProgressDialog();
                Toast.makeText(HodProfileActivity.this, "" + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    public void logOutDialog() {
        MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(HodProfileActivity.this);
        ...
        builder.setPositiveButton("Logout",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i = new Intent(HodProfileActivity.this, LoginActivity.class);
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(HodProfileActivity.this);
        ...
        call.enqueue(new Callback<ApiResponse>() {
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                ...
                switch (statusCode) {
                    case 200:
                        ...
                        if (status) {
                            if (msg.equals("Profile Pic Updated")) {
                                ...
                                Toast.makeText(HodProfileActivity.this, "Profile picture updated", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(HodProfileActivity.this, "Please select valid file", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(HodProfileActivity.this, "Please select valid file", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    case 500:
                        hideProgressDialog();
                        Toast.makeText(HodProfileActivity.this, "Server error", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (addJpgSignatureToGallery(signatureBitmap)) {
                    ...
                    Toast.makeText(HodProfileActivity.this, "Unable to store the signature", Toast.LENGTH_SHORT).show();
                }
                dialog.dismiss();
            }
        });
                    ...
                    case 200:
                        ...
                        if (status) {
                            if (msg.equals("Signature Updated")) {
                                ...
                                Toast.makeText(HodProfileActivity.this, "Signature Updated", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(HodProfileActivity.this, "Error occurred try again later", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(HodProfileActivity.this, "Error occurred try again later", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void showProgressDialog(String msg) {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(HodProfileActivity.this);
