...
public class SupSignReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sup_sign_report);
    ...
    private void initializeViews() {
        ...
        String[] status = {"Accept", "Reject"};
        ArrayAdapter status_adapter = new ArrayAdapter(SupSignReportActivity.this, R.layout.list_item, status);
    ...
    private void SendReportData(ReportResponse reportResponse) {
        ...
        Call<ApiResponse> call = api.superintendentSubmit(reportResponse);
        call.enqueue(new Callback<ApiResponse>() {
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                ...
                switch (statusCode) {
                    case 200:
                        ...
                        if (status) {
                            if (msg.equals("Report Submitted Successfully")) {
                                Toast.makeText(SupSignReportActivity.this, msg, Toast.LENGTH_SHORT).show();
                                if (!TextUtils.isEmpty(coDeviceId)) {
                                    pushNotificationToCoordinator(coDeviceId, coStatus);
                                }
                    ...
                    case 500:
                        hideProgressDialog();
                        Toast.makeText(SupSignReportActivity.this, "Server error", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
            ...
            public void onFailure(Call<ApiResponse> call, Throwable t) {
                hideProgressDialog();
                Toast.makeText(SupSignReportActivity.this, "" + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void NavigateActivity() {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(SupSignReportActivity.this, SuperintendentHomeActivity.class);
    ...
    private void pushNotificationToCoordinator(String token, String coStatus) {
    ...
    private void pushNotificationToFaculty(String facultyId, String coStatus) {
        ...
        String message = "Hi, " + fullName + "\n" + "your report is submitted by " + supName + "\n" +
                "Status :" + coStatus;
        String title = "Report Status";
        JSONObject data = new JSONObject();
        JSONObject json = new JSONObject();
    ...
    private void showProgressDialog(String msg) {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(SupSignReportActivity.this);
