...
public class SuperintendentHomeActivity extends AppCompatActivity implements ReportReceivedAdapter.RecycleItemViewClicked {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_superintendent_home);
    ...
    private void initializeViews() {
        ...
        reportId = preferencesManager.getStringValue(AppConstants.PREF_SUP_NOTIFICATION_REPORT_ID);
    ...
    private void initializeClickEvent() {
        profileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SuperintendentHomeActivity.this, SupProfileActivity.class);
    ...
    private void getReports() {
        ...
        Call<SubmitReportResponse> call = api.getReportBySupId(userId);
        call.enqueue(new Callback<SubmitReportResponse>() {
            ...
            public void onResponse(Call<SubmitReportResponse> call, Response<SubmitReportResponse> response) {
                ...
                switch (statusCode) {
                    case 200:
                            ...
                            if (msg.equals("Record Found")) {
                                ...
                                if (!reportResponseModels.isEmpty()) {
                                    ...
                                    if (isFromNotification && !TextUtils.isEmpty(reportId)) {
                                        ...
                                        adapter = new ReportReceivedAdapter(SuperintendentHomeActivity.this, reportResponseList, SuperintendentHomeActivity.this);
                                        recyclerView.setAdapter(adapter);
                                    } else {
                                        adapter = new ReportReceivedAdapter(SuperintendentHomeActivity.this, reportResponseModels, SuperintendentHomeActivity.this);
                                        recyclerView.setAdapter(adapter);
                                    }
                                ...
                                Toast.makeText(SuperintendentHomeActivity.this, "" + msg, Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(SuperintendentHomeActivity.this, "" + msg, Toast.LENGTH_SHORT).show();
                        }
                        break;
                    case 500:
                        Toast.makeText(SuperintendentHomeActivity.this, "Server error", Toast.LENGTH_SHORT).show();
                        hideProgressDialog();
                        break;
                }
            }
            ...
            public void onFailure(Call<SubmitReportResponse> call, Throwable t) {
                hideProgressDialog();
                Toast.makeText(SuperintendentHomeActivity.this, "" + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void showProgressDialog(String msg) {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(SuperintendentHomeActivity.this);
    ...
    public void onItemViewSelected(GenerateReportResponse.ReportResponseModel reportModel) {
        ...
        Intent intent = new Intent(SuperintendentHomeActivity.this, ReportDetailsActivity.class);
